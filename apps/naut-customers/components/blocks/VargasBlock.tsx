...
export default function VargasBlock(props: {
  title: string;
  description: string;
  cta1Link: string;
  cta1Text: string;
      ...
      <div className="mx-auto max-w-7xl py-12 sm:px-6 sm:py-24 lg:px-8">
        <div className="relative isolate overflow-hidden bg-color1 px-6 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
          <div className="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6 lg:justify-start">
              {props.cta1Text && props.cta1Icon ? (
                <IconLink
                  href={props.cta1Link}
                  className="flex items-center justify-center rounded-md bg-bg1 px-3.5 py-2.5 text-sm font-semibold text-color1 shadow-sm hover:bg-bg1/80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
          ...
          <div className="relative h-96 mt-12 sm:mt-16 lg:mt-0">
            <img className="absolute -left-6 sm:-left-16 md:-left-24 top-0 lg:w-[57rem] lg:h-[56rem] lg:ml-16 w-[100vw] h-[110vw] max-w-none bg-white/5 ring-1 ring-white/10 object-cover object-center" src="https://colegiocuernavaca.edu.mx/bandera.jpg" alt="App screenshot" width="1824" height="1080" />
          </div>
        </div>
      </div>
    </div>
