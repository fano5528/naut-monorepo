...
export default function HerbertBlock(props: {title1: string, title2: string, description1: string, description2: string, image1: string, image2: string, cta1: boolean, cta2: boolean, ctaText1?: string, ctaText2?: string, ctaLink1?: string, ctaLink2?: string, edit: boolean, reference: any}) {
  return (
    <>
