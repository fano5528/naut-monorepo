...
export default function ShakespeareBlock(props: {
  subtitle: string;
  title: string;
  content: {
    image: string;
        ...
        <div>
          ...
          {props.ctaText && props.ctaLink && (
            <IconLink
              ...
              icon="arrow-right"
              className="inline-flex items-center text-color2/80 hover:text-color2 font-normal mt-6 relative after:absolute after:bottom-0 after:left-0 after:h-[1px] after:w-0 after:bg-color2 after:transition-all hover:after:w-full"
            >
              {props.ctaText}
            </IconLink>
          )}
