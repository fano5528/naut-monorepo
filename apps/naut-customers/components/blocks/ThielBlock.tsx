...
export default function ThielBlock(props: {subtitle: string, title: string, description: string, image: string, content: {name: string, description: string, icon: string}[], edit: boolean, reference: any}) {
  return (
    <>
