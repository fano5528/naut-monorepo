...
export default function GreeneBlock( props: {title: string, isDescription: boolean, description?: string, content: {image: string, url: string, text: string}[], edit: boolean, reference: any} ) {
  return (
    <>
