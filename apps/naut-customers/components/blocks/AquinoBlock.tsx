...
export default function AquinoBlock(props: {
  edit: boolean;
  reference: any;
  title: string;
  description: string;
  ...
  return (
    <motion.div
      className="mx-auto max-w-7xl mt-24 sm:px-6 sm:mt-32 lg:px-8"
      ...
      <div className="relative isolate overflow-hidden bg-neutral-900 px-6 py-24 text-center shadow-2xl sm:rounded-3xl sm:px-16">
        ...
        <div className="mt-10 flex items-center justify-center gap-x-6">
          {props.isCta1 && (
            <Link
              href={props.cta1Link!}
              className="rounded-md bg-white px-3.5 py-2.5 text-sm font-semibold text-gray-900 shadow-sm hover:bg-neutral-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
