...
export default function KnightBlock( props: { subtitle: string, title: string, description: string, content: {icon: string, name: string, description?: string}[], edit: boolean, reference: any } ) {
  return (
