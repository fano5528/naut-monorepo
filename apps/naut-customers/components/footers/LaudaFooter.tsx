  ...
  return (
    <footer className="mt-24 sm:mt-32 bg-footer/20 text-color1 border-t border-color1/10">
      <div className="mx-auto max-w-7xl px-8 pt-12 md:pt-16 lg:px-12">
        ...
        {/* Social Icons */}
        <div className="mt-16 py-8 border-t border-color1/10 flex justify-between">
          <Link href="https://internaut.nyc3.cdn.digitaloceanspaces.com/colegiocuernavaca.edu.mx/aviso%20de%20privacidad%20ampliado%202025.pdf" target="_blank" rel="noopener noreferrer">
            <p className="text-xs leading-6 text-color1/70 hover:text-color1 underline">
              Aviso de privacidad
            </p>
          </Link>
