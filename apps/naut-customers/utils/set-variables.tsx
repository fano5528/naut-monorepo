...
export async function setVariables( domain: string ) {
  ...
  * {
    ...
    ${siteData[0].font2 ? `--font-font2: var(--font-${siteData[0].font2}) !important;` : `--font-font2: var(--font-sans) !important;`}
    ${siteData[0].font3 ? `--font-font3: var(--font-${siteData[0].font3}) !important;` : `--font-font3: var(--font-sans) !important;`}
