...
export default function MorinBlock(props: Props) {
  return (
            ...
            <div className="rounded-2xl bg-bg2 py-10 text-center ring-1 ring-inset ring-title/5 lg:flex lg:flex-col lg:justify-center lg:py-16">
              <div className="mx-auto max-w-xs px-8">
                ...
                <Link
                  ...
                  edit={props.edit}
                  className="mt-10 block w-full rounded-md bg-color1 px-3 py-2 text-center text-sm font-semibold text-white shadow-xs hover:bg-color1hover focus-visible:outline-solid focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-color1"
                >
                  {props.ctaText}
                </Link>
