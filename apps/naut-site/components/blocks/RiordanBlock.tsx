        ...
        <div className="mx-auto max-w-2xl text-center">
          ...
          >
            <Link
              ...
              href={props.ctaLink1}
              className="rounded-md bg-title px-3.5 py-2.5 text-sm font-semibold text-bg1 shadow-xs hover:bg-text focus-visible:outline-solid focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-title"
            >
              {props.ctaText1}
            </Link>
            {props.isCta2 ? (
