...
export default function LevittBlock(props: Props) {
    ...
    <>
              ...
              >
                <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-sm sm:p-6">
                  ...
                  <div className="mt-5 sm:mt-6">
                    <button
                      type="button"
                      className="inline-flex w-full justify-center rounded-md bg-[#2adf94] px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-[#2adf94] focus-visible:outline-solid focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                      onClick={() => recalculate()}
                    >
                      Cerrar
                    </button>
      ...
      <div className="mt-24 sm:mt-32 flex justify-center gap-10 flex-col lg:flex-row items-center lg:px-10">
        <div className="max-w-lg px-10 sm:px-0">
          ...
          {props.isCta && (
            <Link
              className="inline-block w-auto mt-6 rounded-md bg-color1 px-5 py-3 text-sm font-semibold text-white shadow-xs hover:bg-color1hover focus-visible:outline-solid focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-color1"
              href={props.ctaLink!}
