...
export default function GilmourHero(props: Props) {
  return (
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              {props.isCta1 && (
                ...
                >
                  <Link
                    href={props.cta1Link!}
                    className="rounded-md bg-color1 px-5 py-2.5 text-sm font-semibold text-title shadow-xs hover:bg-color1hover focus-visible:outline-solid focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-color1"
                    edit={props.edit}
