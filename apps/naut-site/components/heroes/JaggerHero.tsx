...
export default function JaggerHero(props: Props) {
  return (
    <>
    <style jsx global>{`
  .rich-text-container {
...
`}</style>
    <div className="relative">
      <svg
        className=" absolute inset-x-0 top-0 -z-10 h-256 w-full stroke-bg2 mask-[radial-gradient(32rem_32rem_at_center,white,transparent)]"
        aria-hidden="true"
      >
        <defs className="-z-10">
          <pattern
      ...
      >
        <div
          className="aspect-801/1036 w-200.25 bg-linear-to-tr from-color2 to-color2 opacity-30"
          style={{
            clipPath:
                  ...
                  props.cta1Color ? (
                    ...
                    >
                      ...
                      <IconLink
                        ...
                        icon={props.cta1Icon}
                        className="px-3.5 py-2.5 text-sm font-semibold text-white shadow-xs focus-visible:outline-solid focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-color1 relative z-10 block"
                        iconFirst
                      >
                        {props.cta1Text}
                      </IconLink>
                    ...
                    <IconLink
                      ...
                      textName={props.reference.cta1Text}
                      icon={props.cta1Icon}
                      className="rounded-md px-3.5 py-2.5 text-sm font-semibold text-white shadow-xs bg-color1 hover:bg-color1hover focus-visible:outline-solid focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-color1"
                      iconFirst
                    >
                      {props.cta1Text}
                    </IconLink>
