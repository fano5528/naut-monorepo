...
export default function WatersHero(props: Props) {
    ...
    <div>
      ...
      >
        <Image
          ...
          src={props.image}
          className="absolute inset-0 -z-10 h-screen w-full object-cover opacity-30"
        />
        <div
        ...
        >
          <div
            className="relative left-[calc(50%-11rem)] aspect-1155/678 w-144.5 -translate-x-1/2 rotate-30 bg-linear-to-tr from-color1 to-color1 opacity-20 sm:left-[calc(50%-30rem)] sm:w-288.75"
            style={{
              clipPath:
        ...
        >
          <div
            className="relative left-[calc(50%+3rem)] aspect-1155/678 w-144.5 -translate-x-1/2 bg-linear-to-tr from-color1 to-color1 opacity-20 sm:left-[calc(50%+36rem)] sm:w-288.75"
            style={{
              clipPath:
                "polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)",
            }}
      ...
      <div className="relative" aria-hidden="true">
        <div
          className={`${
            props.isLight
              ? ""
              : "absolute left-0 inset-x-0 bottom-0 bg-linear-to-t pt-[13%] from-bg1"
          }`}
        />
      </div>
    </div>
