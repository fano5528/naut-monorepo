...
export default function DylanHero(props: Props) {
    ...
    <div className="overflow-hidden relative h-[90vh] w-full box-border">
      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <div className="absolute inset-0 bg-linear-to-b from-bg1/70 from-10% to-bg1/10 to-20%" />
          <div className="absolute inset-0 bg-linear-to-t from-bg1 to-bg1/10 to-35%" />
