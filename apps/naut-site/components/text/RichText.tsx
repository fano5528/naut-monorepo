...
export default function RichText({ content, edit, name, onChange, className }: RichTextEditorProps) {
  ...
  if (typeof window === 'undefined') {
    return (
      <div
        className={`rich-text-container ${className ? className : "text-base leading-7"} text-text`}
    ...
    return (
      <div className="prose max-w-none">
        <div className="border rounded-lg">
          ...
          <EditorContent editor={editor} className={`p-4 rich-text-container ${className ? className : "text-base leading-7"}`} />
