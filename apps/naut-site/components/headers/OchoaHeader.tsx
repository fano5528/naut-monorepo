...
export default function OchoaHeader(props: Props) {
      ...
      <AnimatePresence mode="sync">
        {mobileMenuOpen && (
          <motion.div
            ...
            exit={{ opacity: 0 }}
            key="mobile-menu"
            className="fixed top-0 bg-black inset-y-0 right-0 z-50 w-full overflow-y-auto px-10 py-6 sm:max-w-sm sm:ring-1 h-screen ring-black transition-none"
          >
