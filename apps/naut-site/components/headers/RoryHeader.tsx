...
export default function RoryHeader(props: Props) {
            ...
            {props.rightMenu.map((item) =>
              item.isCta ? (
                <Headerlink
                  ...
                  href={item.href}
                  key={item.name}
                  className="hidden lg:block rounded-md bg-color1 px-3 py-2 text-sm font-semibold text-title hover:text-text shadow-xs hover:bg-color1hover focus-visible:outline-solid focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-color1"
                >
                  {item.name}
                </Headerlink>
              ) : (
              ...
              {props.rightMenu.map((item) =>
                item.isCta ? (
                  <Headerlink
                    ...
                    href={item.href}
                    key={item.name}
                    className="ml-auto rounded-md bg-color1 px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-color1hover focus-visible:outline-solid focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-color1"
                  >
                    {item.name}
                  </Headerlink>
                ) : (
