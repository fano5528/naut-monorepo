  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        href: "https://internaut.nyc3.cdn.digitaloceanspaces.com/colegiocuernavaca.edu.mx/directorio-comercial.pdf",
      },
    ],
  },
  {
...
export default function OrtizHeader(props: Props) {
  ...
  return (
    <>
      <div className="header relative">
        <div
          className={`${
            hasScrolled
              ...
              : "bg-header/0 w-screen px-10 py-8"
              ...
              {props.rightMenu.map((item) =>
                item.isCta ? (
                  <HeaderIconLink
                    icon="comments"
                    href={item.href}
                    className="bg-[#58d466] hover:bg-[#58d466]/90 text-bg1 px-6 py-2.5 shadow-xs hover:shadow-none text-sm overflow-hidden relative hidden sm:block font-semibold tracking-tight"
                    key={item.name}
                    edit={props.edit}
                  >
                    {item.name}
                  ...
                  >
                    {item.name}
                    <div className="absolute inset-x-1/2 w-0 group-hover:w-full group-hover:inset-x-0 h-px bg-title group-hover:bg-title/70"></div>
                  </Headerlink>
                )
              )}
            </div>
        ...
        >
          <div className="flex justify-between items-center h-screen w-[90vw] mx-auto gap-8">
            ...
            <div className="h-full grow flex-col justify-center px-8 hidden sm:flex">
