...
export default function SennaFooter(props: {
  edit: boolean;
  ref: any;
  ...
  return (
    <footer className="mt-24 sm:mt-32 bg-footer w-full py-24 px-16 sm:px-28 md:px-36 relative block">
        ...
        <div className="flex flex-col gap-5 items-start mt-12 sm:mt-0">
          {props.navigation.map((item, index) => (
            ...
            >
              ...
              >
                {item.name}
                <div className="relative h-[1px] w-[200%] grid grid-cols-2 -ml-[100%] group-hover:ml-0 -mt-[3px]">
                  <div className="w-full h-[1px] bg-footertext" />
                  <div className="w-full h-[1px] bg-footertext/30" />
                </div>
              </Headerlink>
      ...
      <div className="flex mt-24 sm:mt-48 justify-between items-center">
        <motion.div
          whileInView={{ opacity: 1, y: 0, scale: 1 }}
          initial={{ opacity: 0, y: 10, scale: 0.99 }}
          viewport={{ amount: 0.9, once: true }}
        ...
        >
          <Headerlink href="/" edit={props.edit}>
            <Image
              src="https://res.cloudinary.com/coolors/image/upload/v1710341248/live/permanent/gscvariuir9hrffmxku7.png"
              width={100}
              height={100}
              alt="White icon"
