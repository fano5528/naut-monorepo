...
export default function Example(props: {
  ...
  return (
    <div className="relative isolate overflow-hidden bg-bg1">
      <svg
        className="absolute inset-0 -z-10 h-full w-full stroke-title/10 [mask-image:radial-gradient(100%_100%_at_top_right,white,transparent)]"
        aria-hidden="true"
      >
        <defs>
          <pattern
      ...
      >
        <div
          className="aspect-[1108/632] w-[69.25rem] bg-gradient-to-r from-color1 to-color1 opacity-20"
          style={{
            clipPath:
