...
export default function GrohlHero(props: {
  title: string;
  description: string;
  isCta1: boolean;
  isCta2: boolean;
              ...
              <div className="mt-16 flow-root sm:mt-24">
                <div className="w-full -m-2 rounded-xl bg-title/20 p-2 ring-1 ring-inset ring-title/30 lg:-m-4 lg:rounded-2xl lg:p-4 relative">
                  <div className="w-full h-full absolute top-0 left-0 bg-transparent flex justify-center items-center flex-col">
                    <button
                      className="bg-color1 hover:bg-color1hover z-10 p-5 rounded-full shadow-xl ring-[10px] hover:ring-4 ring-color1/20 hover:ring-color1/40"
