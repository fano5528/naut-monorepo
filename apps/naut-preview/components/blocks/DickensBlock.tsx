...
export default function DickensBlock(params: Props) {
  return (
    <div className="w-full sm:w-complete-sm mt-24 sm:mt-32 mx-auto">
      <div className="w-full block relative isolate overflow-hidden bg-color1 px-6 py-24 text-center shadow-2xl sm:rounded-3xl sm:px-16">
        ...
        <Text
          edit={params.edit}
          name={params.reference.description}
        ...
        <div className="mt-10 flex items-center justify-center gap-x-6">
          <Link
            href={params.ctaLink}
            className="font-font2 rounded-md bg-bg1 px-8 py-3 text-md font-semibold text-color1 shadow-sm hover:bg-bg2 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-bg1"
            edit={params.edit}
            linkName={params.reference.ctaLink}
            textName={params.reference.ctaText}
          >
            {params.ctaText}
          </Link>
        </div>
