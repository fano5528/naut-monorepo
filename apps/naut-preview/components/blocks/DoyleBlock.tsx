          ...
          {props.tiers.map((tier: any) => (
            ...
            >
              ...
              <LoadingLink
                ...
                className={classNames(
                  tier.mostPopular
                    ? "bg-color1 text-white shadow-sm hover:bg-color1hover"
                    : "text-color1 hover:text-color1hover ring-1 ring-inset ring-color1 hover:ring-color1hover",
                  "mt-6 block rounded-md py-2 px-3 text-center text-sm font-semibold leading-6 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-color1"
                )}
              >
                ¡Comenzar!
              </LoadingLink>
