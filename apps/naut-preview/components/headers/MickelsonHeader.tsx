...
export default function MickelsonHeader(props: {
  edit: boolean;
  logo: string;
  ...
  return (
    ...
    <header className={`${hasScrolled ? "bg-header/50 backdrop-blur-sm" : ""} fixed z-20 w-full top-0`}>
      <nav
      ...
      >
        ...
        <Dialog.Panel className="fixed inset-y-0 right-0 z-30 w-full overflow-y-auto bg-header/50 backdrop-blur-sm px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
